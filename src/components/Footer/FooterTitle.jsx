...
const FooterTitle = () => {
    ...
    return (
        <section ref={ftConRef} className='relative z-1 w-screen h-[40vh] border-1 border-t-[#6D001A] bg-[#000000]'>
            <div className='w-full flex justify-between items-center px-6 mt-8'>
                <p className='text-[#FFFFFF] text-[0.7rem]'>
                    Site réalisé par —<a href="#" className='text-[#6D001A] font-bold'>ADX Creative</a>
                </p>
                <p className='text-[#FFFFFF] text-[0.7rem]'>
                    Ce site utilise des <a href="#" className='text-[#6D001A] font-bold'>cookies</a>
                </p>
                <p className='text-[#FFFFFF] text-[0.7rem]'>
                    Tous droits réservés © <a href="#" className='text-[#6D001A] font-bold'>2026</a>
                </p>
            </div>

            <div className='footer-title w-full text-center'>
                <h1 className='text-[18vw] font-bold text-[#FFFFFF]'>
                    ADX<sub className="text-[#6D001A]">®</sub>
                </h1>
            </div>
        </section>
    );
