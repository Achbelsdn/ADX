            ...
            >
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">Sites Web<br /> Immersifs 3D</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">WebGL</p>
                    </div>
                    <img
                        src={acImg1}
                        alt="Activité 1"
                    ...
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Créez une présence en ligne captivante avec des expériences<br />3D interactives qui plongent vos visiteurs dans votre univers.</p>
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">Applications Web<br />Interactives</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">React/Three.js</p>
                    </div>
                    <img
                        src={acImg2}
                        alt="Activité 2"
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Développez des applications performantes et modernes avec<br />les dernières technologies web pour une expérience inégalée.</p>
                        <div className="flex justify-center items-center">
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">Branding &amp;<br />Design UI/UX</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">Figma/Design</p>
                    </div>
                    <img
                        src={acImg3}
                        alt="Activité 3"
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Concevez une identité visuelle forte et une interface<br />utilisateur intuitive qui marquent les esprits et convertissent.</p>
                        <div className="flex justify-center items-center">
