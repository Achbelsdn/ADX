        ...
        <div className="preloader relative z-51">
            <div className="preloader-progress">
                ...
                <div className="preloader-logo">
                    <h1 ref={preloaderLogoRef} className="logo-text">ADX</h1>
                </div>
            </div>
            ...
            <div className="preloader-content">
                <div className="preloader-footer">
                    <p>
                        Les expériences digitales naissent entre créativité et technologie,
                        où le design rencontre l'innovation et où chaque pixel raconte une histoire.
                    </p>
                </div>
            </div>
        </div>
